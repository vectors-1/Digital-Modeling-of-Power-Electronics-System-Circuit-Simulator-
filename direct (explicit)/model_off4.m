function [tf,yf,tedf,yedf] = model_off4(Vgg,Lg,Ls,Lp,Ld,Rg,Rpac,Rpdc,Rb,Cgs,f_Cgd,f_Cds,f_Cd,Kp,Vth,Vfto,Rd2,Vdc,IL,Vdsmax,Vdmax,n,m,Vin,tend)
% y1=Id y2=Vds y3=Ig y4=Vgs y5=Ia y6=Vak 
% 

opts1 = odeset('RelTol',1e-5,'AbsTol',1e-5,'events',@(t,y)offEvent(t,y,Rb,Vdc));
...
opts2 = odeset('RelTol',1e-5,'AbsTol',1e-5);
