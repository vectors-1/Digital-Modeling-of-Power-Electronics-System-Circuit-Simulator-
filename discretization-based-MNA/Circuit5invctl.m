%% Circuit2.m
classdef Circuit5invctl < handle
    properties
    ...
    methods
        function obj = Circuit5invctl(netlistStr, numNodes)
...
dbg_show = 0;
                ...
                if carrierwave < modularwave_a
                    ...
                    obj.components{2}.state = 0;
                    obj.components{4}.state = 1;
                end
                if carrierwave < modularwave_b
                    obj.components{6}.state = 1;
                    obj.components{8}.state = 0;
                else
                    obj.components{6}.state = 0;
                    obj.components{8}.state = 1;
                end
                if carrierwave < modularwave_c
                    obj.components{10}.state = 1;
                    obj.components{12}.state = 0;
                else
                    obj.components{10}.state = 0;
                    obj.components{12}.state = 1;
                end
